...
class AWSELBUnitTest(test_lib.ParserTestCase):
  """Tests for AWS ELB access log parser."""
  ...
  def testParse(self):
    ...
    # Test number of events and wrarnings
    ...
    expected_event_values = {
        ...
        "chosen_cert_arn": "arn:aws:abc:us-east-2:234567891234:certificate/a246f123-221c-56a1-d3bc-c01860f9f16e",
        "classification": "-",
        ...
        "target_group_arn": "arn:aws:elasticloadbalancing:us-east-2:123456789123:targetgroup/dev-abc/13ff1ec1f13456f1",
