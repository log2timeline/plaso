...
class AppleRecoveryLogdIPSPluginTest(test_lib.IPSPluginTestCase):
  ...
  _PROCESS_LIST = [
      ...
      'c'
      'om.apple.PDFKit.PDFExtensionVi',
  ...
  def testProcess(self):
    ...
    expected_event_values = {
        ...
        'kernel_version': (
            'Darwin Kernel Version 22.1.0: Thu Oct  6 19:33:53 '
            'PDT 2022; root:xnu-8792.42.7~1/RELEASE_ARM64_T8020'),
        'operating_system_version': 'iPhone OS 16.1 (20B82)',
        'process_list': ', '.join(self._PROCESS_LIST),
