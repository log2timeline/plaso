...
class WinPrefetchParserTest(test_lib.ParserTestCase):
    ...
    def testParse17(self):
        ...
        storage_writer = self._ParseFile(["winprefetch", "CMD.EXE-087B4001.pf"], parser)
    ...
    def testParse26(self):
        ...
        expected_mapped_files = [
            ...
            ("\\DEVICE\\HARDDISKVOLUME2\\WINDOWS\\SYSTEM32\\TPMTASKS.DLL [47003-1]"),
    ...
    def testParse30Variant1Compressed(self):
        ...
        expected_event_values = {
            ...
            "previous_run_times": ["2015-05-14T22:10:28.6747101+00:00"],
            "run_count": 2,
            "version": 30,
        }
    ...
    def testParse30Variant2Compressed(self):
        ...
        expected_event_values = {
            ...
            "previous_run_times": ["2019-06-05T19:23:00.8157052+00:00"],
            "run_count": 2,
            "version": 30,
        }
