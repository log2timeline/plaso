...
class TeamViewerConnectionsIncomingLogTextPluginTest(test_lib.TextPluginTestCase):
...
class TeamViewerConnectionsOutgoingLogTextPluginTest(test_lib.TextPluginTestCase):
