...
class BitbucketAccessTextPluginTest(test_lib.TextPluginTestCase):
  ...
  def testParse(self):
    ...
    expected_event_values = {
        ...
        'http_response_bytes_written': 13,
    ...
    expected_event_values = {
        ...
        'http_request_method': 'GET',
        'http_request_uri': (
            '/rest/api/latest/projects/AAAAA/repos/main/pull-requests/394/diff'),
    ...
    expected_event_values = {
        ...
        'remote_address': '172.5.1.1',
        'request_id': 'o@1QGGCWQx626x45680x0',
        'request_time': 1397,
        'session_id': 'vlumts',
