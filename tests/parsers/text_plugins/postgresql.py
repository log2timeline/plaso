...
class PostgreSQLTextPluginTest(test_lib.TextPluginTestCase):
  ...
  def testCheckRequiredFormat(self):
    ...
    file_object = io.BytesIO(
        b'2022-04-12 00:16:05.526 UTC [7755] LOG:  starting PostgreSQL '
        b'12.9 (Ubuntu 12.9-0ubuntu0.20.04.1) on x86_64-pc-linux-gnu, '
        b'compiled by gcc (Ubuntu 9.3.0-17ubuntu1~20.04) 9.3.0, 64-bit\n')
