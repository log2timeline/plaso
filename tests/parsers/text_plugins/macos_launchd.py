...
class MacOSLaunchdLogTextPluginTest(test_lib.TextPluginTestCase):
    ...
    def testProcess(self):
        ...
        plugin = macos_launchd.MacOSLaunchdLogTextPlugin()
        storage_writer = self._ParseTextFileWithPlugin(["macos_launchd.log"], plugin)
        ...
        expected_event_values = {
            "body": ("launchd logging initialized. name: com.apple.xpc.launchd pid: 1"),
            "severity": "Notice",
        ...
        event_data = storage_writer.GetAttributeContainerByIndex("event_data", 36603)
        self.CheckEventData(event_data, expected_event_values)
