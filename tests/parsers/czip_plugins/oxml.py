...
class OXMLTest(test_lib.CompoundZIPPluginTestCase):
    ...
    _PROPERTIES_XML_DATA = "".join(
        [
            ...
            (
                ...
                "2012-11-07T23:29:00.1234567Z</dcterms:created>"
            ),
            (
                '<dcterms:modified xsi:type="dcterms:W3CDTF">'
                "2013-08-25T22:18:00Z</dcterms:modified>"
            ),
            "</cp:coreProperties>",
        ]
    )
    ...
    def testParseRelationshipsXMLFile(self):
        ...
        property_files = plugin._ParseRelationshipsXMLFile(self._RELATIONSHIPS_XML_DATA)
