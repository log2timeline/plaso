...
class MDNSResourceRecordTypeFormatStringDecoderTest(shared_test_lib.BaseTestCase):
...
class OpenDirectoryMembershipTypeFormatStringDecoderTest(shared_test_lib.BaseTestCase):
...
class SignpostDescriptionAttributeFormatStringDecoderTest(shared_test_lib.BaseTestCase):
...
class SignpostDescriptionTimeFormatStringDecoderTest(shared_test_lib.BaseTestCase):
...
class SignpostTelemetryNumberFormatStringDecoderTest(shared_test_lib.BaseTestCase):
...
class SignpostTelemetryStringFormatStringDecoderTest(shared_test_lib.BaseTestCase):
...
class TraceV3FileTest(shared_test_lib.BaseTestCase):
    ...
    def testReadCatalog(self):
        ...
        test_file_path = "/private/var/db/Diagnostics/Signpost/0000000000000001.tracev3"
        test_path_spec = path_spec_factory.Factory.NewPathSpec(
            dfvfs_definitions.TYPE_INDICATOR_APFS,
            location=test_file_path,
            parent=self._parent_path_spec,
    ...
    def testReadOversizeChunkData(self):
        ...
        oversize_chunk = test_file._ReadOversizeChunkData(self._OVERSIZE_CHUNK_DATA, 0)
...
class UUIDTextFileTest(shared_test_lib.BaseTestCase):
    ...
    def testReadFileFooter(self):
        ...
        test_file_path = "/private/var/db/uuidtext/22/3ED293DBE031C889F9F7689D86339D"
        test_path_spec = path_spec_factory.Factory.NewPathSpec(
            dfvfs_definitions.TYPE_INDICATOR_APFS,
            location=test_file_path,
            parent=self._parent_path_spec,
...
class UnifiedLoggingParserTest(test_lib.ParserTestCase):
    ...
    def testParseWithPersistTraceV3(self):
        ...
        test_file_path = "/private/var/db/Diagnostics/Persist/0000000000000001.tracev3"
        test_path_spec = path_spec_factory.Factory.NewPathSpec(
            dfvfs_definitions.TYPE_INDICATOR_APFS,
            location=test_file_path,
            parent=self._parent_path_spec,
    ...
    def testParseWithSpecialTraceV3(self):
        ...
        test_file_path = "/private/var/db/Diagnostics/Special/0000000000000001.tracev3"
        test_path_spec = path_spec_factory.Factory.NewPathSpec(
            dfvfs_definitions.TYPE_INDICATOR_APFS,
            location=test_file_path,
            parent=self._parent_path_spec,
