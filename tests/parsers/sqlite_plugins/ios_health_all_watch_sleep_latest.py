    ...
    def testProcess(self):
        ...
        for i in range(number_of_event_data):
            ...
            if (
                ...
                == expected_event_values["start_date_str"]
                and getattr(event_data, "end_date_str", None)
                == expected_event_values["end_date_str"]
                and getattr(event_data, "sleep_state_code", None)
                == expected_event_values["sleep_state_code"]
                and getattr(event_data, "sleep_state_hms", None)
