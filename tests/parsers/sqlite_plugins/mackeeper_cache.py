...
class MacKeeperCachePluginTest(test_lib.SQLitePluginTestCase):
    ...
    def testProcess(self):
        ...
        storage_writer = self._ParseDatabaseFileWithPlugin(
            ["sqlite", "mackeeper_cache.db"], plugin
        )
        ...
        expected_event_values = {
            ...
            "url": (
                "http://support.kromtech.net/chat/listen/"
                "12828340738351e0593f987450z40787/?client-id=51e0593fa1a24468673655&"
                "callback=jQuery183013571173651143909_1373657420912&_=1373657423647"
            ),
            "user_sid": None,
            "username": None,
        }
