#!/usr/bin/env python3
"""Tests the for WinCC log file parser."""
...
class SIMATICTest(test_lib.ParserTestCase):
    ...
    def testParse(self):
        ...
        storage_writer = self._ParseFile(["wincc_simatic_s7_proto_suite.log"], parser)
        ...
        expected_event_values = {
            ...
            "message_body": ("419 INFO     | LogFileCount  : 3"),
        }
...
class WinCCSyslogTest(test_lib.ParserTestCase):
    ...
    def testParse(self):
        ...
        storage_writer = self._ParseFile(["wincc_sys.log"], parser)
        number_of_event_data = storage_writer.GetNumberOfAttributeContainers(
            "event_data"
        )
        ...
        expected_event_values = {
            ...
            "log_identifier": 2303,
            "message_body": (
                "[(null) 224]failed to insert into MSARCLONG with "
