...
class WinlogonPluginTest(test_lib.RegistryPluginTestCase):
    ...
    def _CreateTestKey(self):
        ...
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "AutoAdminLogon", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        ...
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "Background", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)

        value_data = "10".encode("utf_16_le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "CachedLogonsCount", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)

        value_data = "no".encode("utf_16_le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "DebugServerCommand", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)

        value_data = "".encode("utf_16_le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "DefaultDomainName", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)

        value_data = "user".encode("utf_16_le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "DefaultUserName", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)
        ...
        value_data = "".encode("utf_16_le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "LegalNoticeCaption", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)

        value_data = "".encode("utf_16_le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "LegalNoticeText", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)
        ...
        value_data = "1".encode("utf_16_le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "ReportBootOk", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)
        ...
        value_data = "SystemPropertiesPerformance.exe/pagefile".encode("utf_16_le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
        ...
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "StartShell", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        navlogon_key.AddValue(registry_value)
        ...
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "StopScreenSaver", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        secret_malware_key.AddValue(registry_value)
