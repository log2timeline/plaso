...
class CupsIppParserTest(test_lib.ParserTestCase):
    ...
    def testParseAttribute(self):
        ...
        attribute_data = self._CreateAttributeTestData(parser, 0x00, "test", b"\x12")
        ...
        attribute_data = self._CreateAttributeTestData(parser, 0x22, "bool", b"\x01")
        file_object = self._CreateFileObject("cups_ipp", attribute_data)
        ...
        attribute_data = self._CreateAttributeTestData(parser, 0x47, "charset", b"utf8")
        file_object = self._CreateFileObject("cups_ipp", attribute_data)
    ...
    def testParseAttributesGroup(self):
        ...
        file_object = self._CreateFileObject("cups_ipp", self._ATTRIBUTES_GROUP_DATA)
    ...
    def testParse(self):
        ...
        expected_event_values = {
            ...
            "job_identifier": "urn:uuid:d51116d9-143c-3863-62aa-6ef0202de49a",
