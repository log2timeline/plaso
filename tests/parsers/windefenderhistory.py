...
class WinDefenderHistoryUnitTest(test_lib.ParserTestCase):
  ...
  def testWebFileDetection(self):
    ...
    for event in storage_writer.GetEvents():
      ...
      self.assertEqual(
          ...
          event_data.filename)
      self.assertEqual(
          'C:\\Users\\Luqman\\Downloads\\Ransomware.Jigsaw.zip|http://10.1.20'
          '.13:8000/Ransomware.Jigsaw.zip|pid:1020,'
          'ProcessStart:132525829301711007',
          event_data.web_filename)
      self.assertEqual(
          '86a391fe7a237f4f17846c53d71e45820411d1a9a6e0c16f22a11ebc491ff9ff',
          event_data.sha256)
      self.assertEqual('Trojan:Win32/Vigorf.A', event_data.threat_name)
  ...
  def testContainerDetection(self):
    ...
    for event in storage_writer.GetEvents():
      event_data = self._GetEventDataOfEvent(storage_writer, event)
      self.assertEqual(
          'C:\\Users\\bkara\\AppData\\Local\\Mozilla\\Firefox\\Profiles\\2k4x3'
          'nr9.default-release\\cache2\\entries\\32F0AE83BF7D7CFE8D5B679DE93E8'
          'E189345BB6C->(GZip)->(SCRIPT0001)',
          event_data.filename)
      self.assertEqual(
          '82e242b2951403ef2d288fb97f428b830900530f85f1b4689a6130b328aa4c45',
          event_data.sha256)
      self.assertEqual('Trojan:HTML/Phish.VS!MSR', event_data.threat_name)
      self.assertEqual(
          'C:\\Users\\bkara\\AppData\\Local\\Mozilla\\Firefox\\Profiles\\2k4x3'
          'nr9.default-release\\cache2\\entries\\32F0AE83BF7D7CFE8D5B679DE93E8'
          'E189345BB6C',
  ...
  def testProcessBasedDetection(self):
    ...
    for event in storage_writer.GetEvents():
      event_data = self._GetEventDataOfEvent(storage_writer, event)
      self.assertEqual('Trojan:Win32/Delf.BB', event_data.threat_name)
      self.assertEqual(
          'process://C:\\Program Files (x86)\\DesktopCentral_Agent'
          '\\dcconfig.exe,pid:53668,ProcessStart:133004481826348874',
          event_data.filename)
      self.assertEqual(
  ...
  def testNoFilenameFrenchSystem(self):
    ...
    for event in storage_writer.GetEvents():
      ...
      self.assertEqual(
          ...
          '-EncodedCommand QQBkAGQALQBNAHAAUAByAGUAZgBlAHIAZQBuAGMAZQAgAC0A'
          'RQB4AGMAbAB1AHMAaQBvAG4ARQB4AHQAZQBuAHMAaQBvAG4AIABAACgAJwBlAHgA'
          'ZQAnACwAJwBkAGwAbAAnACkAIAAtAEYAbwByAGMAZQA=, C:\\Windows\\System'
          '32\\WindowsPowerShell\\v1.0\\powershell.exe -EncodedCommand QQBk'
          'AGQALQBNAHAAUAByAGUAZgBlAHIAZQBuAGMAZQAgAC0ARQB4AGMAbAB1AHMAaQBv'
          'AG4AUABhAHQAaAAgAEAAKAAkAGUAbgB2ADoAVQBzAGUAcgBQAHIAbwBmAGkAbABl'
          'ACwAJABlAG4AdgA6AFMAeQBzAHQAZQBtAEQAcgBpAHYAZQApACAALQBGAG8AcgBj'
          'AGUA, i AQAAAIkSBYAAAAAAAAAAAGchilvXwQAAoQYaJ1g0xpRzihIDOX+yDaJM'
          'TaBWaXJUb29sOldpbjMyL0V4Y2x1ZGVQcm9jLkQAAAAAAAAAAAAAAAAAAAAAAAAA'
          'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA== 57 10 C:\\Windows\\System32\\Wi'
          'ndowsPowerShell\\v1.0\\powershell.exe powershell -EncodedCommand'
          ' QQBkAGQALQBNAHAAUAByAGUAZgBlAHIAZQBuAGMAZQAgAC0ARQB4AGMAbAB1AHM'
          'AaQBvAG4ARQB4AHQAZQBuAHMAaQBvAG4AIABAACgAJwBlAHgAZQAnACwAJwBkAGw'
          'AbAAnACkAIAAtAEYAbwByAGMAZQA=, i AQAAAIkSBYAAAAAAAAAAAGchilvXwQA'
          'AoQYaJ1g0xpRzihIDOX+yDaJMTaBWaXJUb29sOldpbjMyL0V4Y2x1ZGVQcm9jLkQ'
          'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA== 57 10 '
          'C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe p'
          'owershell -EncodedCommand QQBkAGQALQBNAHAAUAByAGUAZgBlAHIAZQBuAG'
          'MAZQAgAC0ARQB4AGMAbAB1AHMAaQBvAG4AUABhAHQAaAAgAEAAKAAkAGUAbgB2AD'
          'oAVQBzAGUAcgBQAHIAbwBmAGkAbABlACwAJABlAG4AdgA6AFMAeQBzAHQAZQBtAE'
          'QAcgBpAHYAZQApACAALQBGAG8AcgBjAGUA',
          event_data.extra)
