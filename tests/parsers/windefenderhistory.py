...
class WinDefenderHistoryUnitTest(test_lib.ParserTestCase):
    ...
    def testWebFileDetection(self):
        ...
        storage_writer = self._ParseFile([
            'defender/f34a0f70391bc24ecd465f713c6b068cc24dd05d71994924abbb438ba9eecf62'
        ], parser)
        ...
        for event in storage_writer.GetEvents():
            ...
            self.assertEqual(
                ...
                event_data.filename)
            self.assertEqual(
                'C:\\Users\\Luqman\\Downloads\\Ransomware.Jigsaw.zip|http://10.1.20.13:8000/Ransomware.Jigsaw.zip|pid:1020,ProcessStart:132525829301711007',
    ...
    def testContainerDetection(self):
        ...
        parser = windefenderhistory.WinDefenderHistoryParser()
        storage_writer = self._ParseFile([
            'defender/5f747e1ce825ffb36d0cbd7e9348886e79a71f7f317b1c0afe11f6baafa35015'
        ], parser)
        ...
        for event in storage_writer.GetEvents():
            event_data = self._GetEventDataOfEvent(storage_writer, event)
            self.assertEqual(
                'C:\\Users\\bkara\\AppData\\Local\\Mozilla\\Firefox\\Profiles\\2k4x3nr9.default-release\\cache2\\entries\\32F0AE83BF7D7CFE8D5B679DE93E8E189345BB6C->(GZip)->(SCRIPT0001)',
                event_data.filename)
            self.assertEqual(
            ...
            self.assertEqual(
                'C:\\Users\\bkara\\AppData\\Local\\Mozilla\\Firefox\\Profiles\\2k4x3nr9.default-release\\cache2\\entries\\32F0AE83BF7D7CFE8D5B679DE93E8E189345BB6C',
    ...
    def testRegistryBasedDetection(self):
        ...
        parser = windefenderhistory.WinDefenderHistoryParser()
        storage_writer = self._ParseFile([
            'defender/233c51b726822b2223142d8d05976509936ce28323006f7f8a89ca1e8b7f14b6'
        ], parser)
    ...
    def testProcessBasedDetection(self):
        ...
        parser = windefenderhistory.WinDefenderHistoryParser()
        storage_writer = self._ParseFile([
            'defender/535d641be9356b67a4fa15fafd516187fa6c2e585e16be6813b56f47ead81c83'
        ], parser)
        ...
        for event in storage_writer.GetEvents():
            ...
            self.assertEqual(
                'process://C:\\Program Files (x86)\\DesktopCentral_Agent\\dcconfig.exe,pid:53668,ProcessStart:133004481826348874',
                event_data.filename)
            self.assertEqual(
    ...
    def testNoFilenameFrenchSystem(self):
        ...
        parser = windefenderhistory.WinDefenderHistoryParser()
        storage_writer = self._ParseFile([
            'defender/b7c5b9dc8388a709849bbf6c7a03b3a55ae8a1edaa87c16779bf01668ebce299'
        ], parser)
