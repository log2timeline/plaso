...
class LinuxStandardBaseReleasePluginTest(test_lib.ArtifactPreprocessorPluginTestCase):
...
class LinuxUserAccountsPluginTest(test_lib.ArtifactPreprocessorPluginTestCase):
    ...
    def testParseFileData(self):
        ...
        user_account = storage_writer.GetAttributeContainerByIndex("user_account", 11)
