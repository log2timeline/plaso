...
class WindowsAllUsersAppDataKnowledgeBasePluginTest(
    ...
    def testCollectWithAllUsersProfile(self):
        ...
        test_mediator._environment_variables["ALLUSERSPROFILE"] = environment_variable
    ...
    def testCollectWithProgramData(self):
        ...
        environment_variable = artifacts.EnvironmentVariableArtifact(
            case_sensitive=False, name="programdata", value="%SystemDrive%\\ProgramData"
        )
...
class WindowsEventLogPublishersPluginTest(WindowsArtifactPreprocessorPluginTestCase):
...
class WindowsEventLogSourcesPluginTest(WindowsArtifactPreprocessorPluginTestCase):
    ...
    def testParseValueData(self):
        ...
        self._RunPreprocessorPluginOnWindowsRegistryValueSystem(storage_writer, plugin)
...
class WindowsMountedDevicesPluginTest(WindowsArtifactPreprocessorPluginTestCase):
    ...
    def testParseValueData(self):
        ...
        attribute_containers = list(
            storage_writer.GetAttributeContainers("windows_mounted_device")
        )
...
class WindowsSystemRootEnvironmentVariablePluginTest(
    ...
    def testParsePathSpecification(self):
        ...
        file_system_builder = fake_file_system_builder.FakeFileSystemBuilder()
        file_system_builder.AddFile("/Windows/System32/config/SYSTEM", self._FILE_DATA)
...
class WindowsSystemProductPluginTest(WindowsArtifactPreprocessorPluginTestCase):
...
class WindowsSystemVersionPluginTest(WindowsArtifactPreprocessorPluginTestCase):
...
class WindowsUserAccountsPluginTest(WindowsArtifactPreprocessorPluginTestCase):
    ...
    def testParseKey(self):
        ...
        user_account = storage_writer.GetAttributeContainerByIndex("user_account", 0)

        self.assertEqual(
            user_account.identifier, "S-1-5-21-2036804247-3058324640-2116585241-1114"
        )
