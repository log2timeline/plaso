...
class BaseEngineTest(shared_test_lib.BaseTestCase):
    ...
    def testBuildCollectionFilters(self):
        ...
        session = test_engine.CreateSession(artifact_filter_names=artifact_filter_names)
        ...
        self.assertIn("test_data", trie_root.children)
        self.assertIn("*.evtx", trie_root.children["test_data"].children)
        self.assertIn("Users", trie_root.children)
        users_child = trie_root.children["Users"]
        self.assertIn("testuser1", users_child.children)
        self.assertIn("testuser2", users_child.children)
        testuser1_child = users_child.children["testuser1"]
        testuser2_child = users_child.children["testuser2"]
        self.assertIn("Documents", testuser1_child.children)
        self.assertIn("Documents", testuser2_child.children)
        documents_child_user1 = testuser1_child.children["Documents"]
        documents_child_user2 = testuser2_child.children["Documents"]
        self.assertIn("WindowsPowerShell", documents_child_user1.children)
        self.assertIn("WindowsPowerShell", documents_child_user2.children)
        self.assertIn(
            "profile.ps1", documents_child_user1.children["WindowsPowerShell"].children
        )
        self.assertIn(
            "profile.ps1", documents_child_user2.children["WindowsPowerShell"].children
        )
