...
class CPUTimeProfilerTest(shared_test_lib.BaseTestCase):
    ...
    def testStartStopTiming(self):
        ...
        with shared_test_lib.TempDirectory() as temp_directory:
            ...
            test_profiler = profilers.CPUTimeProfiler("test", profiling_configuration)
...
class MemoryProfilerTest(shared_test_lib.BaseTestCase):
    ...
    def testSample(self):
        ...
        with shared_test_lib.TempDirectory() as temp_directory:
            ...
            test_profiler = profilers.MemoryProfiler("test", profiling_configuration)
...
class AnalyzersProfilerTest(shared_test_lib.BaseTestCase):
    ...
    def testStartStopTiming(self):
        ...
        with shared_test_lib.TempDirectory() as temp_directory:
            ...
            test_profiler = profilers.AnalyzersProfiler("test", profiling_configuration)
...
class TaskQueueProfilerTest(shared_test_lib.BaseTestCase):
    ...
    def testSample(self):
        ...
        with shared_test_lib.TempDirectory() as temp_directory:
            ...
            test_profiler = profilers.TaskQueueProfiler("test", profiling_configuration)
