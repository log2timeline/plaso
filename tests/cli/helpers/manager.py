...
class HelperManagerTest(unittest.TestCase):
    ...
    def testHelperRegistration(self):
        ...
        self.assertEqual(
            len(manager.ArgumentHelperManager._helper_classes), number_of_helpers + 1
        )
        ...
        self.assertEqual(
            len(manager.ArgumentHelperManager._helper_classes), number_of_helpers
        )
