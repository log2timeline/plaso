...
class AnalysisPluginOptionsTest(test_lib.CLIToolTestCase):
    ...
    def testListAnalysisPlugins(self):
        ...
        expected_line = "browser_search : Analyze browser search entries from events."
        self.assertIn(expected_line, lines)


class TestToolWithHashersOptions(tools.CLITool, tool_options.HashersOptions):
...
class TestToolWithOutputModuleOptions(tools.CLITool, tool_options.OutputModuleOptions):
...
"""
    ...
    def testListOutputModules(self):
        ...
        lines = frozenset(lines)
        disabled_outputs = list(output_manager.OutputManager.GetDisabledOutputClasses())
...
class TestToolWithProfilingOptions(tools.CLITool, tool_options.ProfilingOptions):
...
class TestToolWithStorageFileOptions(tools.CLITool, tool_options.StorageFileOptions):
