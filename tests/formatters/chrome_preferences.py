...
class ChromePreferencesPrimaryURLFormatterHelperTest(test_lib.EventFormatterTestCase):
...
class ChromePreferencesSecondaryURLFormatterHelperTest(test_lib.EventFormatterTestCase):
    ...
    def testFormatEventValues(self):
        ...
        formatter_helper.FormatEventValues(output_mediator, event_values)
        self.assertEqual(event_values["secondary_url"], "https://anotherexample.com")
        ...
        event_values = {"primary_url": "https://example.com", "secondary_url": ""}
        formatter_helper.FormatEventValues(output_mediator, event_values)
        self.assertEqual(event_values["secondary_url"], "local file")

        event_values = {"primary_url": "https://example.com", "secondary_url": None}
        formatter_helper.FormatEventValues(output_mediator, event_values)
        self.assertIsNone(event_values["secondary_url"])
