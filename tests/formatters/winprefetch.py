...
class WindowsPrefetchPathHintsFormatterHelperTest(test_lib.EventFormatterTestCase):
...
class WindowsPrefetchVolumesStringFormatterHelperTest(test_lib.EventFormatterTestCase):
