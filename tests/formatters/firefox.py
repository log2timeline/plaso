...
class FirefoxHistoryTypedCountFormatterHelperTest(test_lib.EventFormatterTestCase):
...
class FirefoxHistoryURLHiddenFormatterHelperTest(test_lib.EventFormatterTestCase):
