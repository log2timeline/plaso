...
class WindowsTaggingFileTest(test_lib.TaggingFileTestCase):
    ...
    def testApplicationExecution(self):
        ...
        attribute_values_per_name = {"filename": ["C:/Windows/Tasks/At/bogus.job"]}
        ...
        attribute_values_per_name = {"strings": [["user mode service", "demand start"]]}
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData,
            attribute_values_per_name,
            ["application_execution"],
        ...
        attribute_values_per_name = {"filename": ["Recent"], "local_path": ["file.exe"]}
        self._CheckTaggingRule(
        ...
        attribute_values_per_name = {}
        self._CheckTaggingRule(
            winprefetch.WinPrefetchExecutionEventData,
            attribute_values_per_name,
            ["application_execution"],
        )
        ...
        attribute_values_per_name = {}
        self._CheckTaggingRule(
            appcompatcache.AppCompatCacheEventData,
            attribute_values_per_name,
            ["application_execution"],
        )
        ...
        attribute_values_per_name = {"value_name": ["file.exe"]}
        self._CheckTaggingRule(
        ...
        attribute_values_per_name = {}
        self._CheckTaggingRule(
            winjob.WinJobEventData, attribute_values_per_name, ["application_execution"]
        )
    ...
    def testDocumentOpen(self):
        ...
        attribute_values_per_name = {}
        self._CheckTaggingRule(
            officemru.OfficeMRUWindowsRegistryEventData,
            attribute_values_per_name,
            ["document_open"],
        )
    ...
    def testLoginFailed(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["login_failed"]
        )
    ...
    def testLoginAttempt(self):
        ...
        self._CheckTaggingRule(
            winevt.WinEvtRecordEventData, attribute_values_per_name, ["login_attempt"]
        )
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["login_attempt"]
        )
    ...
    def testShellStart(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["shell_start"]
        )
    ...
    def testTaskSchedule(self):
        ...
        self._CheckTaggingRule(
            winevt.WinEvtRecordEventData, attribute_values_per_name, ["task_schedule"]
        )
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["task_schedule"]
        )
    ...
    def testJobSuccess(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["job_success"]
        )
    ...
    def testTimeChange(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["time_change"]
        )
    ...
    def testShutdown(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["shutdown"]
        )
    ...
    def testSystemStart(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["system_start"]
        )
    ...
    def testSystemSleep(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["system_sleep"]
        )
    ...
    def testSystemWake(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["system_wake"]
        )
    ...
    def testAutorun(self):
        ...
        attribute_values_per_name = {"value": ["file.exe", "file.dll"]}
        self._CheckTaggingRule(
        ...
        attribute_values_per_name = {"image_path": ["file.exe", "file.dll"]}
        self._CheckTaggingRule(
            lfu.WindowsBootVerificationEventData, attribute_values_per_name, ["autorun"]
        )

        # Test: data_type is 'windows:registry:run' AND
        #       (entries contains '.exe' OR entries contains '.dll')
        attribute_values_per_name = {"entries": ["file.exe", "file.dll"]}
        self._CheckTaggingRule(
    ...
    def testServiceNew(self):
        ...
        self._CheckTaggingRule(
            winevtx.WinEvtxRecordEventData, attribute_values_per_name, ["service_new"]
        )
