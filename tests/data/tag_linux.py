...
class LinuxTaggingFileTest(test_lib.TaggingFileTestCase):
    ...
    def testRuleApplicationExecution(self):
        ...
        self._CheckTaggingRule(
            bash_history.BashHistoryEventData,
            attribute_values_per_name,
        ...
        attribute_values_per_name = {}
        self._CheckTaggingRule(
            fish_history.FishHistoryEventData,
            attribute_values_per_name,
            ["application_execution"],
        )
        ...
        attribute_values_per_name = {"audit_type": ["EXECVE", "USER_CMD"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData,
            attribute_values_per_name,
            ["application_execution"],
        )
        ...
        attribute_values_per_name = {}
        self._CheckTaggingRule(
            zsh_extended_history.ZshHistoryEventData,
            attribute_values_per_name,
            ["application_execution"],
        )
        ...
        attribute_values_per_name = {}
        self._CheckTaggingRule(
            syslog.SyslogCronTaskRunEventData,
            attribute_values_per_name,
            ["application_execution"],
        )
    ...
    def testRuleLogin(self):
        ...
        attribute_values_per_name = {"audit_type": ["LOGIN"]}
        self._CheckTaggingRule(
    ...
    def testRuleLoginFailed(self):
        ...
        attribute_values_per_name = {"audit_type": ["ANOM_LOGIN_FAILURES"]}
        self._CheckTaggingRule(
    ...
    def testRuleUserAdd(self):
        ...
        attribute_values_per_name = {"audit_type": ["ADD_USER"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["useradd"]
        )
    ...
    def testRuleGroupAdd(self):
        ...
        attribute_values_per_name = {"audit_type": ["ADD_GROUP"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["groupadd"]
        )

        # Test: reporter is 'groupadd'
        attribute_values_per_name = {"reporter": ["groupadd"]}
        self._CheckTaggingRule(
            syslog.SyslogLineEventData, attribute_values_per_name, ["groupadd"]
        )
    ...
    def testRuleUserDel(self):
        ...
        attribute_values_per_name = {"audit_type": ["DEL_USER"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["userdel"]
        )
    ...
    def testRuleGroupDel(self):
        ...
        attribute_values_per_name = {"audit_type": ["DEL_GROUP"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["groupdel"]
        )

        # Test: reporter is 'groupdel'
        attribute_values_per_name = {"reporter": ["groupdel"]}
        self._CheckTaggingRule(
            syslog.SyslogLineEventData, attribute_values_per_name, ["groupdel"]
        )
    ...
    def testRuleFirewallChange(self):
        ...
        attribute_values_per_name = {"audit_type": ["NETFILTER_CFG"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["firewall_change"]
        )
    ...
    def testRuleBoot(self):
        ...
        attribute_values_per_name = {"audit_type": ["SYSTEM_BOOT"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["boot"]
        )
    ...
    def testRuleRunlevel(self):
        ...
        attribute_values_per_name = {"audit_type": ["SYSTEM_RUNLEVEL"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["runlevel"]
        )
    ...
    def testRuleDeviceConnection(self):
        ...
        self._CheckTaggingRule(
            syslog.SyslogLineEventData, attribute_values_per_name, ["device_connection"]
        )
    ...
    def testRuleServiceStart(self):
        ...
        attribute_values_per_name = {"audit_type": ["SERVICE_START"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["service_start"]
        )
    ...
    def testRuleServiceStop(self):
        ...
        attribute_values_per_name = {"audit_type": ["SERVICE_STOP"]}
        self._CheckTaggingRule(
            selinux.SELinuxLogEventData, attribute_values_per_name, ["service_stop"]
        )
    ...
    def testRulePromiscuous(self):
        ...
        attribute_values_per_name = {"audit_type": ["ANOM_PROMISCUOUS"]}
        self._CheckTaggingRule(
