...
class ChromeExtensionTest(test_lib.AnalysisPluginTestCase):
    ...
    def testExamineEventAndCompileReportMacOSPaths(self):
        ...
        analysis_results = list(
            storage_writer.GetAttributeContainers("chrome_extension_analysis_result")
        )
        ...
        self.assertEqual(
            analysis_result.extension_identifier, "apdfllckaahabafndbhieahigkjlhalf"
        )
        ...
        expected_analysis_counter = collections.Counter({"dude": 1, "frank": 1})
    ...
    def testExamineEventAndCompileReportWindowsPaths(self):
        ...
        user_accounts = [
            artifacts.UserAccountArtifact(
                identifier="S-1",
                path_separator="\\",
                user_directory="C:\\Users\\dude",
                username="dude",
            ),
            artifacts.UserAccountArtifact(
                identifier="S-2",
                path_separator="\\",
                user_directory="C:\\Users\\frank",
                username="frank",
            ),
        ]
        ...
        self.assertEqual(
            analysis_result.extension_identifier, "hmjkmjkepdijhoojdojkdfohbdgmmhki"
        )
        self.assertEqual(analysis_result.username, "dude")
        ...
        expected_analysis_counter = collections.Counter({"dude": 1, "frank": 2})
        self.assertEqual(analysis_report.analysis_counter, expected_analysis_counter)
