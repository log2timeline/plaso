...
class AnalysisPluginManagerTest(shared_test_lib.BaseTestCase):
    ...
    def testPluginRegistration(self):
        ...
        self.assertEqual(
            len(manager.AnalysisPluginManager._plugin_classes), number_of_plugins + 1
        )
        ...
        self.assertEqual(
            len(manager.AnalysisPluginManager._plugin_classes), number_of_plugins
        )
    ...
    def testGetPlugins(self):
        ...
        plugin_set = {
            name for name, _ in list(manager.AnalysisPluginManager.GetPlugins())
        }
