...
class AnalysisPluginTestCase(shared_test_lib.BaseTestCase):
    ...
    def _AnalyzeEvents(self, event_values_list, plugin, user_accounts=None):
        ...
        for (
            ...
            event_data,
            event_data_stream,
        ) in containers_test_lib.CreateEventsFromValues(event_values_list):
        ...
        mediator = analysis_mediator.AnalysisMediator(user_accounts=user_accounts)
        ...
        for event in storage_writer.GetSortedEvents():
            ...
            if event_data:
                ...
                if event_data_stream_identifier:
                    event_data_stream = (
                        storage_writer.GetAttributeContainerByIdentifier(
