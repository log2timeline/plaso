...
class UniqueHashesTest(test_lib.AnalysisPluginTestCase):
  ...
  _TEST_EVENTS = [
      ...
      {'data_type': 'test:event',
       'md5_hash': '4',
       'path_spec': fake_path_spec.FakePathSpec(location='/opt/dfvfs'),
       'timestamp': timelib.Timestamp.CopyFromString('2015-01-01 17:00:02'),
       'timestamp_desc': definitions.TIME_DESCRIPTION_UNKNOWN},
      {'data_type': 'test:event',
       'md5_hash': '4',
       'path_spec': fake_path_spec.FakePathSpec(location='/opt/2hash_file'),
       'sha256_hash': '5',
       'timestamp': timelib.Timestamp.CopyFromString('2015-01-01 17:00:03'),
       'timestamp_desc': definitions.TIME_DESCRIPTION_UNKNOWN},
      {'data_type': 'test:event',
       'path_spec': fake_path_spec.FakePathSpec(location='/opt/no_hash_file'),
