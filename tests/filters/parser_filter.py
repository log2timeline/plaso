...
class ParserFilterExpressionHelperTest(test_lib.FilterTestCase):
    ...
    def testExpandPresets(self):
        ...
        self.assertEqual(parser_filter_expression, expected_parser_filter_expression)
    ...
    def testSplitExpression(self):
        ...
        excludes, includes = test_helper.SplitExpression("!excluded,!excluded/plugin1,")
        ...
        excludes, includes = test_helper.SplitExpression("included,included/plugin1")
        self.assertEqual(excludes, {})
