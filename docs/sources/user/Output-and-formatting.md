...
elastic_ts | Output events to an ElasticSearch database for use with Timesketch. Requires elasticsearch-py. Mainly intended to be used by Timesketch importer.
