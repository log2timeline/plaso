...
2. If you are running the development release make sure plaso and dependencies are up to date, see: [Developers Guide](../developer/Developers-Guide.html)
...
culprit is. Also see: [Profiling memory usage](../developer/Profiling.html#profiling-memory-usage)

## Also see

* [Troubleshooting Mac OS X specific issues](Troubleshooting-MacOS.html)
* [Troubleshooting Ubuntu specific issues](Troubleshooting-Ubuntu.html)
* [Troubleshooting Windows specific issues](Troubleshooting-Windows.html)
