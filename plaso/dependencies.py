...
PYTHON_DEPENDENCIES = {
    ...
    "dfdatetime": ("__version__", "20260730", None, True),
    "dfvfs": ("__version__", "20260731", None, True),
    ...
    "pyfsfat": ("get_version()", "20260717", None, True),
    ...
    "pytsk3": ("get_version()", "20260715", None, True),
