...
class OperatingSystemArtifact(ArtifactAttributeContainer):
    ...
    _DEFAULT_FAMILY_AND_VERSION = (definitions.OPERATING_SYSTEM_FAMILY_UNKNOWN, (0, 0))
    ...
    _FAMILY_AND_VERSION_PER_NAME = {
        ...
        "Windows 2003 R2": (definitions.OPERATING_SYSTEM_FAMILY_WINDOWS_NT, (5, 2)),
        "Windows 2008": (definitions.OPERATING_SYSTEM_FAMILY_WINDOWS_NT, (6, 0)),
        "Windows 2008 R2": (definitions.OPERATING_SYSTEM_FAMILY_WINDOWS_NT, (6, 1)),
        "Windows 2012": (definitions.OPERATING_SYSTEM_FAMILY_WINDOWS_NT, (6, 2)),
        "Windows 2012 R2": (definitions.OPERATING_SYSTEM_FAMILY_WINDOWS_NT, (6, 3)),
    ...
    def _GetNameFromProduct(self):
        ...
        if "windows" in product_lower_case:
            ...
            if (
                suffix_segment_index < number_of_segments
                and product_lower_case[suffix_segment_index] == "r2"
            ):
    ...
    def IsEquivalent(self, other):
        ...
        * family
        ...
        if self.name:
            ...
            return (
                self_family == other.family
                and self_version_tuple == other.version_tuple
            )
        ...
        if self.family and self.version:
            ...
            return (
                self.family == other_family
                and self.version_tuple == other_version_tuple
            )
...
class TimeZoneArtifact(ArtifactAttributeContainer):
    ...
    def __init__(self, localized_name=None, mui_form=None, name=None, offset=None):
...
class WindowsEventLogProviderArtifact(ArtifactAttributeContainer):
    ...
    _SERIALIZABLE_PROTECTED_ATTRIBUTES = ["_system_configuration_identifier"]
