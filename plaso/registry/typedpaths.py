...
"""This file contains the Typed Paths plugins for Plaso."""
...
class TypedPaths(win_registry_interface.KeyPlugin):
  """Base class for all Typed Paths Key plugins."""
  ...
  def GetEntries(self):
    """Collect Values under the Typed Paths and return event for each one."""
...
class TypedPathsPlugin(TypedPaths):
  """Gathers the Typed Path key for the NTUSER hive."""
