...
_PATHSPEC_TSKFSATTRTYPE = _descriptor.EnumDescriptor(
  name='TskFsAttrType',
...
_PATHBUNDLE = _descriptor.Descriptor(
  name='PathBundle',
...
_PATHFILTER = _descriptor.Descriptor(
  name='PathFilter',
...
class PathFilter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
