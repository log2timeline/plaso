...
_ANALYSISREPORT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='_event_tags', full_name='plaso_storage.AnalysisReport._event_tags', index=7,
...
_ANALYSISREPORT.fields_by_name['_event_tags'].message_type = _EVENTTAG
