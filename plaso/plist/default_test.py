  ...
  def setUp(self):
    ...
    self.top_level_dict_single = {
        'DE-00-AD-00-BE-EF': {
            ...
            datetime(2012, 11, 2, 1, 21, 38, 997672, tzinfo=pytz.utc)}}
