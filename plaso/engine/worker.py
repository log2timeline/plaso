...
class BaseEventExtractionWorker(queue.ItemQueueConsumer):
  ...
  def GetStatus(self):
    ...
    return {
        u'display_name': self._status_diplay_name,
  ...
  def ParseFileEntry(self, file_entry):
    ...
    self._status_diplay_name = self._parser_mediator.GetDisplayName()
    ...
    # We do not clear self._status_diplay_name here to allow the foreman
