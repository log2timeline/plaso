...
class EventFormatter(object):
  ...
  def _FormatMessage(self, format_string, event_values):
    ...
    try:
      ...
      logging.warning(
          u'Unicode error in event object [{0:s}] which was generated by '
          u'parser chain: {1:s}. Error was: {2:s}. The event will not be '
          u'included in the timeline.'.format(
              event_values[u'uuid'], event_values[u'parser'], exception))
      message_string = u''
