...
class WindowsPrefetchPathHintsFormatterHelper(interface.CustomEventFormatterHelper):
...
class WindowsPrefetchVolumesStringFormatterHelper(interface.CustomEventFormatterHelper):
