...
class FSEventsdEventFormatter(interface.ConditionalEventFormatter):
  ...
  _FLAG_VALUES = {
      0x00000000: 'None',
      0x00000001: 'DirectoryCreated',
      0x00000002: 'FinderInfoModified',
      0x00000004: 'Exchange',
      0x00000008: 'Modified',
      0x00000010: 'Renamed',
      0x00000020: 'InodeMetadataModified',
      0x00000040: 'Removed',
      0x00000080: 'Created',
      0x00000200: 'ItemCloned',
      0x00000800: 'DocumentRevision',
      0x00002000: 'ExtendedAttributeRemoved',
      0x00004000: 'ExtendedAttributeModified',
      0x00008000: 'PermissionChanged',
      0x00010000: 'IsFile',
      0x00020000: 'IsSymbolicLink',
      0x00080000: 'IsHardLink',
      0x00100000: 'LastHardLinkRemoved',
      0x04000000: 'EndOfTransaction',
      0x20000000: 'Unmount',
      0x40000000: 'Mount',
      0x80000000: 'IsDirectory'}
