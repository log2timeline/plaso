...
TIME_DESCRIPTION_AWS_ELB_RESPONSE_SENT = 'Response sent to client'
TIME_DESCRIPTION_AWS_ELB_REQUEST_RECEIVED = 'Request received from client'
...
TIME_DESCRIPTION_LAST_EXIT = 'Process Exit Time'
