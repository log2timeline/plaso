...
TIME_ACTIVATION_CONVERSATION = 'Activation Conversation'
TIME_CONVERSATION_RENAMED = 'Conversation Renamed'
...
TIME_END_VIDEO_CALL = 'End Video Call'
TIME_INVITATION_CONVERSATION = 'Invitation Conversation'
TIME_LATEST_READ = 'Latest Read'
TIME_LOCATION_VISITED = 'Location Visited'
TIME_MESSAGE_SENT = 'Message Sent'
TIME_PAGE_VISITED = 'Page Visited'
TIME_SORTING_CONVERSATION = 'Sorting Conversation'
TIME_START_VIDEO_CALL = 'Start Video Call'
TIME_USER_ADDED = 'User Added'
TIME_USER_REMOVED = 'User Removed'
