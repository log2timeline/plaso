...
class BitbucketAuditTextPlugin(interface.TextPlugin):
    ...
    DATA_FORMAT = "Atlassian Bitbucket audit log (atlassian-bitbucket-audit.log) file"
    ...
    _EVENT_NAME = pyparsing.Word(pyparsing.alphanums + "_").set_results_name(
        "event_name"
    )
    ...
    def _ParseRecord(self, parser_mediator, key, structure):
        ...
        details = self._GetValueFromStructure(
            structure, "details", default_value=""
        ).strip()
        ...
        event_data.event_name = self._GetValueFromStructure(structure, "event_name")
    ...
    def CheckRequiredFormat(self, parser_mediator, text_reader):
        ...
        if timestamp_ms is None or not 946684800000 <= timestamp_ms <= 4102444800000:
            return False
