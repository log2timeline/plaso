...
class APTHistoryLogTextPlugin(interface.TextPlugin):
    ...
    _RECORD_START_LINE = pyparsing.Literal("Start-Date:") + _DATE_TIME + _END_OF_LINE
    ...
    _RECORD_END_LINE = pyparsing.Literal("End-Date:") + _DATE_TIME + _END_OF_LINE
    ...
    def _ParseRecordStart(self, structure):
        ...
        self._event_data.start_time = self._ParseTimeElements(time_elements_structure)
