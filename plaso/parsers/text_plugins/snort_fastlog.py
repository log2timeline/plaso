...
class SnortFastLogTextPlugin(
    ...
    _DATE_MONTH_DAY = _TWO_DIGITS + pyparsing.Suppress("/") + _TWO_DIGITS

    _DATE_YEAR_MONTH_DAY = _TWO_DIGITS + pyparsing.Suppress("/") + _DATE_MONTH_DAY
    ...
    _RULE = (
        ...
        + pyparsing.Combine(
            ...
            + pyparsing.Literal(":")
            + _INTEGER
        ).set_results_name("rule_identifier")
        + pyparsing.Suppress("]")
    )
