...
class PopularityContestUnitTest(test_lib.ParserTestCase):
  ...
  def testParse(self):
    ...
    expected_timestamp = timelib.Timestamp.CopyFromString(
        u'2010-06-22 07:34:42.000')
    self.assertEquals(event_objects[9].timestamp, expected_timestamp)
    ...
    expected_timestamp = timelib.Timestamp.CopyFromString(
        u'2010-05-12 07:58:33.000')
    self.assertEquals(event_objects[11].timestamp, expected_timestamp)
    ...
    expected_timestamp = timelib.Timestamp.CopyFromString(
        u'2010-06-22 05:41:41.000')
    self.assertEquals(event_objects[12].timestamp, expected_timestamp)
