...
class LogdParser(text_parser.PyparsingSingleLineTextParser):
    ...
    _TIME_DELTA = pyparsing.Word(pyparsing.nums + '+' + '-', exact=5)('time_delta')
    ...
    def ParseRecord(self, parser_mediator, key, structure):
        ...
        # dfdatetime takes the time zone offset as an int number of minutes but inverts the sign
        # for example Easter Standard Time, which is UTC-5:00 needs to be provided as +300 minutes.
        ...
        try:
            date_time = dfdatetime_time_elements.TimeElements(time_elements_tuple=(
                year, month, day, hours, minutes, seconds), time_zone_offset=time_offset)
