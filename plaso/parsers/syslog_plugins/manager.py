# -*- coding: utf-8 -*-
"""The syslog plugins manager object."""


class SyslogPluginsManager(object):
  """Class that implements the syslog plugins manager."""
  ...
  @classmethod
  def GetPlugins(cls):
    """Retrieves the syslog plugins.

    Returns:
      A list of all syslog plugin objects.
    """
