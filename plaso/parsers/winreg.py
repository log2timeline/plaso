...
class WinRegistryParser(interface.BaseParser):
  ...
  @classmethod
  def GetRegistryPlugins(cls, pre_obj=None):
    ...
    registered_plugins = manager.ParsersManager.GetRegisteredPlugins(
        parent_class=winreg_plugins_interface.RegistryPlugin, pre_obj=pre_obj)
