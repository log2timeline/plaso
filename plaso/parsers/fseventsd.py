...
class FseventsdParser(interface.FileObjectParser, dtfabric_helper.DtFabricHelper):
    ...
    _DEFINITION_FILE = os.path.join(os.path.dirname(__file__), "fseventsd.yaml")
    ...
    def _ParseDLSPageHeader(self, file_object, page_offset):
        ...
        try:
            ...
            raise errors.ParseError(
                f"Unable to parse page header at offset: 0x{page_offset:08x} "
