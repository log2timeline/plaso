...
class ParserMediator:
    ...
    def GetWindowsEventLogMessageFile(self):
        ...
        if (
            self._windows_event_log_providers_per_filename is None
            and self._windows_event_log_providers_per_path is None
        ):
        ...
        lookup_path, _, lookup_filename = lookup_path.rpartition(path_segment_separator)
        ...
        if (
            lookup_path == "\\windows\\systemresources"
            and lookup_filename[-4:] == ".mun"
        ):
