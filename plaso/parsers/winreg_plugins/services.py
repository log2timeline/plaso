...
class ServicesPlugin(interface.WindowsRegistryPlugin):
    ...
    def ExtractEvents(self, parser_mediator, registry_key, **kwargs):
        ...
        event_data.error_control = self._GetValueFromKey(registry_key, "ErrorControl")
        event_data.image_path = self._GetValueFromKey(registry_key, "ImagePath")
        event_data.key_path = registry_key.path
        event_data.last_written_time = registry_key.last_written_time
        event_data.name = registry_key.name
        event_data.object_name = self._GetValueFromKey(registry_key, "ObjectName")
