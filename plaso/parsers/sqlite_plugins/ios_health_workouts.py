...
class IOSHealthWorkoutsPlugin(interface.SQLitePlugin):
    ...
    DATA_FORMAT = "iOS Health Workouts SQLite database file healthdb_secure.sqlite"
    ...
    QUERIES = [
        (
            (
                ...
                "end_date, workouts.activity_type AS activity_type, workouts.duration "
                "AS duration, workouts.total_distance AS total_distance, "
