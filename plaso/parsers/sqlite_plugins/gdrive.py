...
class GoogleDrivePlugin(interface.SQLitePlugin):
  ...
  SCHEMAS = [
      {u'cloud_entry':
       u'CREATE TABLE cloud_entry (resource_id TEXT, filename TEXT, modified '
       u'INTEGER, created INTEGER, acl_role INTEGER, doc_type INTEGER, '
       u'removed INTEGER, url TEXT, size INTEGER, checksum TEXT, shared '
       u'INTEGER, PRIMARY KEY (resource_id))',
       u'cloud_relations':
