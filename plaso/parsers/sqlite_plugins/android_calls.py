...
class AndroidCallPlugin(interface.SQLitePlugin):
  ...
  SCHEMAS = [
      {u'_sync_state':
          ...
          u'TEXT NOT NULL,account_type TEXT NOT NULL,data '
          u'TEXT,UNIQUE(account_name, account_type))',
      u'_sync_state_metadata':
          u'CREATE TABLE _sync_state_metadata (version INTEGER)',
      u'accounts':
          u'CREATE TABLE accounts (_id INTEGER PRIMARY KEY '
          u'AUTOINCREMENT,account_name TEXT, account_type TEXT, data_set '
          u'TEXT)',
      u'agg_exceptions':
      ...
      u'contacts':
          ...
          u'NOT NULL DEFAULT 0,times_contacted INTEGER NOT NULL DEFAULT '
      ...
      u'data':
          u'CREATE TABLE data (_id INTEGER PRIMARY KEY '
          u'AUTOINCREMENT,package_id INTEGER REFERENCES '
          u'package(_id),mimetype_id INTEGER REFERENCES mimetype(_id) NOT '
          u'NULL,raw_contact_id INTEGER REFERENCES raw_contacts(_id) NOT '
          u'NULL,is_read_only INTEGER NOT NULL DEFAULT 0,is_primary INTEGER '
          u'NOT NULL DEFAULT 0,is_super_primary INTEGER NOT NULL DEFAULT '
          u'0,data_version INTEGER NOT NULL DEFAULT 0,data1 TEXT,data2 '
          u'TEXT,data3 TEXT,data4 TEXT,data5 TEXT,data6 TEXT,data7 TEXT,data8 '
          u'TEXT,data9 TEXT,data10 TEXT,data11 TEXT,data12 TEXT,data13 '
          u'TEXT,data14 TEXT,data15 TEXT,data_sync1 TEXT, data_sync2 TEXT, '
          u'data_sync3 TEXT, data_sync4 TEXT )',
      u'data_usage_stat':
      ...
      u'groups':
          ...
          u'AUTOINCREMENT,package_id INTEGER REFERENCES '
          u'package(_id),account_name STRING DEFAULT NULL, account_type '
          u'STRING DEFAULT NULL, data_set STRING DEFAULT NULL, sourceid '
          u'TEXT,version INTEGER NOT NULL DEFAULT 1,dirty INTEGER NOT NULL '
          u'DEFAULT 0,title TEXT,title_res INTEGER,notes TEXT,system_id '
          u'TEXT,deleted INTEGER NOT NULL DEFAULT 0,group_visible INTEGER NOT '
          u'NULL DEFAULT 0,should_sync INTEGER NOT NULL DEFAULT 1,auto_add '
          u'INTEGER NOT NULL DEFAULT 0,favorites INTEGER NOT NULL DEFAULT '
          u'0,group_is_read_only INTEGER NOT NULL DEFAULT 0,sync1 TEXT, sync2 '
          u'TEXT, sync3 TEXT, sync4 TEXT , account_id INTEGER REFERENCES '
          u'accounts(_id))',
      u'mimetypes':
          u'CREATE TABLE mimetypes (_id INTEGER PRIMARY KEY '
          u'AUTOINCREMENT,mimetype TEXT NOT NULL)',
      u'name_lookup':
          u'CREATE TABLE name_lookup (data_id INTEGER REFERENCES data(_id) '
