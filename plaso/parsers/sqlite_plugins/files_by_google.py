"""SQLite parser plugin for "Files by Google" database (Web Data) files.
...
This SQLite database is used by the Files by Google app to manage and organize
files on Android devices. The database contains information on file metadata,
including file names, paths, sizes, and types, as well as records of storage
locations.
"""
...
class FilesByGooglePlugin(interface.SQLitePlugin):
    """SQLite parser plugin for Google "Files by Google" database files."""
    ...
    SCHEMAS = [
        {
            ...
            "files_master_table": (
                "CREATE TABLE files_master_table(id INTEGER PRIMARY KEY "
                "AUTOINCREMENT, media_store_id INTEGER, root_path TEXT NOT NULL "
                "DEFAULT '', root_relative_file_path TEXT NOT NULL DEFAULT '', "
            ...
            "media_store_scan_state_table": (
                ...
                "DEFAULT 0 UNIQUE, largest_scanned_date_modified_ms INTEGER NOT "
                "NULL, largest_scanned_media_store_id INTEGER NOT NULL)"
            ),
            "post_file_scan_tasks_state_table": (
                "CREATE TABLE post_file_scan_tasks_state_table(task_type INTEGER "
                "NOT NULL UNIQUE, largest_processed_file_id INTEGER NOT NULL, "
