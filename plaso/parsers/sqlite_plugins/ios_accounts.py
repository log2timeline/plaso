...
class IOSAccounts(events.EventData):
    ...
    Attributes:
        date (dfdatetime.DateTimeValues): date and time the account was created.
        account_type (str): account type.
        username (str): user name.
        identifier (str): identifier.
        owning_bundle_id (str): owning bundle identifier of the app managing the account.
    """
...
class IOSAccountsPlugin(interface.SQLitePlugin):
    ...
    QUERIES = [((
        ...
        'FROM ZACCOUNT LEFT JOIN ZACCOUNTTYPE ON ZACCOUNT.ZACCOUNTTYPE = ZACCOUNTTYPE.Z_PK'),
        'ParseAccountRow')]
    ...
    SCHEMAS = {
        'ZACCOUNT': (
            ...
            'ZSUPPORTSAUTHENTICATION INTEGER, ZVISIBLE INTEGER, ZACCOUNTTYPE INTEGER, '
            'ZPARENTACCOUNT INTEGER, ZDATE TIMESTAMP, ZLASTCREDENTIALRENEWALREJECTIONDATE TIMESTAMP, '
            'ZACCOUNTDESCRIPTION TEXT, ZAUTHENTICATIONTYPE TEXT, ZCREDENTIALTYPE TEXT, '
            'ZIDENTIFIER TEXT, ZOWNINGBUNDLEID TEXT, ZUSERNAME TEXT, ZDATACLASSPROPERTIES BLOB)'),
        'ZACCOUNTTYPE': (
            'CREATE TABLE ZACCOUNTTYPE (Z_PK INTEGER PRIMARY KEY, Z_ENT INTEGER, '
            'Z_OPT INTEGER, ZENCRYPTACCOUNTPROPERTIES INTEGER, ZOBSOLETE INTEGER, '
            'ZSUPPORTSAUTHENTICATION INTEGER, ZSUPPORTSMULTIPLEACCOUNTS INTEGER, '
            'ZVISIBILITY INTEGER, ZACCOUNTTYPEDESCRIPTION TEXT, ZCREDENTIALPROTECTIONPOLICY TEXT, '
    ...
    def ParseAccountRow(
        ...
        event_data.account_type = self._GetRowValue(query_hash, row, 'ZACCOUNTTYPEDESCRIPTION')
        ...
        event_data.owning_bundle_id = self._GetRowValue(query_hash, row, 'ZOWNINGBUNDLEID')
