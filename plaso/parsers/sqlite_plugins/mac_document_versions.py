...
class MacDocumentVersionsPlugin(interface.SQLitePlugin):
  ...
  SCHEMAS = [
      ...
      u'generations':
          ...
          u'ASC,generation_storage_id INTEGER NOT NULL,generation_name TEXT '
          u'NOT NULL,generation_client_id TEXT NOT NULL,generation_path TEXT '
          u'UNIQUE,generation_options INTEGER NOT NULL DEFAULT '
          u'1,generation_status INTEGER NOT NULL DEFAULT '
          u'1,generation_add_time INTEGER NOT NULL DEFAULT 0,generation_size '
          u'INTEGER NOT NULL DEFAULT 0,generation_prunable INTEGER NOT NULL '
          u'DEFAULT 0)',
      u'storage':
