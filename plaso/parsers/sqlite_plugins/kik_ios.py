...
class KikIOSPlugin(interface.SQLitePlugin):
  ...
  SCHEMAS = [
      {u'Z_3MESSAGES':
       ...
       u'Z_6ADMINSINVERSE':
       u'CREATE TABLE Z_6ADMINSINVERSE ( Z_6ADMINS INTEGER, Z_6ADMINSINVERSE '
       u'INTEGER, PRIMARY KEY (Z_6ADMINS, Z_6ADMINSINVERSE) )',
       u'Z_6BANSINVERSE':
       ...
       u'ZRETRYCOUNT INTEGER, ZSTATE INTEGER, ZTYPE INTEGER, ZEXTRA INTEGER, '
       u'ZMESSAGE INTEGER, ZLASTACCESSTIMESTAMP TIMESTAMP, ZTIMESTAMP '
       u'TIMESTAMP, ZCONTENT VARCHAR )',
       u'ZKIKATTACHMENTEXTRA':
       u'CREATE TABLE ZKIKATTACHMENTEXTRA ( Z_PK INTEGER PRIMARY KEY, Z_ENT '
       u'INTEGER, Z_OPT INTEGER, ZATTACHMENT INTEGER, ZENCRYPTIONKEY BLOB )',
       u'ZKIKCHAT':
       ...
       u'ZKIKMESSAGE':
       u'CREATE TABLE ZKIKMESSAGE ( Z_PK INTEGER PRIMARY KEY, Z_ENT INTEGER, '
       u'Z_OPT INTEGER, ZFLAGS INTEGER, ZINTERNALID INTEGER, ZSTATE INTEGER, '
       u'ZSYSTEMSTATE INTEGER, ZTYPE INTEGER, ZCHATEXTRA INTEGER, '
       u'ZDRAFTMESSAGECHAT INTEGER, ZLASTMESSAGECHAT INTEGER, '
