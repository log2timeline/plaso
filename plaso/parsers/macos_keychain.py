...
class KeychainParser(interface.FileObjectParser, dtfabric_helper.DtFabricHelper):
    """Parser for MacOS keychain database files."""

    NAME = "mac_keychain"
    DATA_FORMAT = "MacOS keychain database file"

    _DEFINITION_FILE = os.path.join(os.path.dirname(__file__), "macos_keychain.yaml")
