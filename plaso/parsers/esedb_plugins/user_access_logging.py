...
class UserAccessLoggingESEDBPlugin(interface.ESEDBPlugin):
    ...
    _DNS_TABLE_VALUE_MAPPINGS = {"Address": "_ConvertDNSAddressValue"}
    ...
    _ROLE_ACCESS_TABLE_VALUE_MAPPINGS = {"RoleGuid": "_ConvertGUIDToString"}

    _ROLE_IDS_TABLE_VALUE_MAPPINGS = {"RoleGuid": "_ConvertGUIDToString"}
    ...
    def _ParseSystemIdentityTable(
        ...
        for record_index, esedb_record in enumerate(table.records):
            ...
            event_data.operating_system_build = record_values.get("OSBuildNumber", None)
