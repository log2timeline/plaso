...
class AzureActivityLogJSONLPlugin(interface.JSONLPlugin):
    ...
    def _ParseRecord(self, parser_mediator, json_dict):
        ...
        event_data.operation_identifier = self._GetJSONValue(json_dict, "operation_id")
        event_data.operation_name = self._GetJSONValue(operation_name_json, "value")
        event_data.recorded_time = date_time
        event_data.resource_group = self._GetJSONValue(json_dict, "resource_group_name")
        event_data.resource_identifier = self._GetJSONValue(json_dict, "resource_id")
