...
schema_helper.SchemaHelper.RegisterDataTypes(
    {
        ...
        "dfvfs.PathSpec": {"json": serializers.JSONPathSpecAttributeSerializer()},
        "List[int]": {"json": serializers.JSONValueListAttributeSerializer()},
        "List[str]": {"json": serializers.JSONValueListAttributeSerializer()},
    }
)
...
class JSONAttributeContainerSerializer(
    ...
    def _ConvertBytesToJSON(cls, bytes_value):
        ...
        return {"__encoding__": "base16", "__type__": "bytes", "stream": encoded_value}
    ...
    def _ConvertTupleToJSON(cls, value):
        ...
        """
        return {"__type__": "tuple", "values": cls._ConvertListToJSON(value)}
