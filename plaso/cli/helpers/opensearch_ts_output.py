    ...
    def AddArguments(cls, argument_group):
        ...
        Args:
          argument_group (argparse._ArgumentGroup|argparse.ArgumentParser):
              argparse group.
        """
        opensearch_output.OpenSearchOutputArgumentsHelper.AddArguments(argument_group)

        argument_group.add_argument(
            "--timeline_identifier",
            "--timeline-identifier",
            dest="timeline_identifier",
            type=int,
...
manager.ArgumentHelperManager.RegisterHelper(OpenSearchTimesketchOutputArgumentsHelper)
