...
class ExtractionArgumentsHelper(interface.ArgumentsHelper):
    ...
    def AddArguments(cls, argument_group):
        ...
        argument_group.add_argument(
            ...
            "--extract-winreg-binary",
            dest="extract_winreg_binary",
            action="store_true",
            default=False,
            help=(
        ...
        argument_group.add_argument(
            ...
            "--skip-compressed-streams",
            dest="process_compressed_streams",
            action="store_false",
            default=True,
            help=(
    ...
    def ParseOptions(cls, options, configuration_object):
        ...
        setattr(configuration_object, "_extract_winreg_binary", extract_winreg_binary)
