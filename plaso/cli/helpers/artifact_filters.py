...
class ArtifactFiltersArgumentsHelper(interface.ArgumentsHelper):
    ...
    def AddArguments(cls, argument_group):
        ...
        argument_group.add_argument(
            "--artifact_filters",
            "--artifact-filters",
            dest="artifact_filter_string",
            type=str,
            default=None,
            metavar="ARTIFACT_FILTERS",
            action="store",
            help=(
        ...
        argument_group.add_argument(
            ...
            "--artifact-filters_file",
            dest="artifact_filters_file",
            type=str,
            default=None,
            metavar="PATH",
            action="store",
    ...
    def ParseOptions(cls, options, configuration_object):
        ...
        artifact_filters_file = cls._ParseStringOption(options, "artifact_filters_file")
