...
class HashersArgumentsHelper(interface.ArgumentsHelper):
    ...
    def AddArguments(cls, argument_group):
        ...
        argument_group.add_argument(
            ...
            "--hasher-file-size-limit",
            dest="hasher_file_size_limit",
            type=int,
            action="store",
            default=0,
            metavar="SIZE",
        ...
        argument_group.add_argument(
            ...
            type=str,
            action="store",
            default=cls._DEFAULT_HASHER_STRING,
            metavar="HASHER_LIST",
            help=(
    ...
    def ParseOptions(cls, options, configuration_object):
        ...
        setattr(configuration_object, "_hasher_file_size_limit", hasher_file_size_limit)
