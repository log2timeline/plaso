...
DPKG_PYTHON3_TEST_DEPENDENCIES="python3-coverage python3-distutils python3-fakeredis python3-mock python3-pbr python3-setuptools";
...
RPM_PYTHON3_TEST_DEPENDENCIES="python3-fakeredis python3-mock python3-pbr python3-setuptools";
