...
class TimeLibUnitTest(unittest.TestCase):
  ...
  def testWinFiletime(self):
    """Test the Windows FILETIME conversion."""
    time = 129533290442500000
    time_exp = 1308855444250000
    self.assertEquals(timelib.WinFiletime2Unix(time), time_exp)
