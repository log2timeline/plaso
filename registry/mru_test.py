...
class TestMRURegistry(unittest.TestCase):
  ...
  def testMRU(self):
    ...
    self.assertEquals(entries[0].description_long, line1)
    self.assertEquals(entries[1].description_long, line2)
    self.assertEquals(entries[2].description_long, line3)
