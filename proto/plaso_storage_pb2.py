...
_EVENTOBJECT = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='data_type', full_name='plaso_storage.EventObject.data_type', index=15,
